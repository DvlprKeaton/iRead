...
public class Q19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("This is a beach. \nThe weather is hot." +
                "\nKate is making sand castle. Sam is boating. A young lady is surfing in the sea." +
                "\nBen is playing with his dog, Bruno..." +
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "This is a beach. The weather is hot." +
                "Kate is making sand castle. Sam is boating. A young lady is surfing in the sea." +
                "Ben is playing with his dog, Bruno..." +
                "How is the weather at the beach?" +
                "is it cold, hot, or rainy?";
        ...
        Toast.makeText(Q19.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
            ...
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("hot")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q20.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q19.this, correctAns+"", Toast.LENGTH_SHORT).show();
