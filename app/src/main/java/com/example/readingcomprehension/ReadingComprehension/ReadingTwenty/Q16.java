...
public class Q16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("I am _____ years old" +
                "\n• 8" +
                "\n• 9" +
                "\n• 10");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "I am blank years old..." +
                "is it 8, 9, or 10?";
        ...
        Toast.makeText(Q16.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("10")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q17.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q16.this, correctAns+"", Toast.LENGTH_SHORT).show();
