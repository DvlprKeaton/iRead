...
public class Q5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("Frank had to stay home from school for several days." +
                "\n His mother called the doctor." +
                "\n The doctor told her about a special lotion that would help the itching." +
                "\n Frank will have to stay home until the rash is gone." +
                "\n Why do you think Frank has to stay home until his rash goes away?" +
                "\n• he is being punished" +
                "\n• so that he doesn't spread it to his friends" +
                "\n• so that he can sleep in bed");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "Frank had to stay home from school for several days. His mother called the doctor. The doctor told her about a special lotion that would help the itching." +
                "Frank will have to stay home until the rash is gone." +
                "Why do you think Frank has to stay home until his rash goes away?" +
                "is it he is being punished, so that he doesn't spread it to his friends, or so that he can sleep in bed?";
        ...
        Toast.makeText(Q5.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("so that he doesn't spread it to his friends")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q6.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q5.this, correctAns+"", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intentQ2 = new Intent(this, Q6.class);
