...
public class Q6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("It is Clara's birthday.\n" +
        "Dad is having a party for her.\n " +
                "He wrapped a present and brought a cake at the store.\n" +
                "All clara needs to do is...\n" +
                "• Wash her hair" +
                "\n• Feed the cat" +
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "It is Clara's birthday." +
                "Dad is having a party for her. " +
                "He wrapped a present and brought a cake at the store." +
                "All clara needs to do is....." +
                "is it Wash her hair, Feed the cat, or blow out her candles?";
        ...
        Toast.makeText(Q6.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("blow out her candles")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q7.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q6.this, correctAns+"", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intentQ2 = new Intent(this, Q7.class);
