...
public class Q20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       q1.setText("What is kate making?" +
               "\n• sand castles" +
               "\n• boat" +
               "\n• house");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "What is kate making?" +
                "is it sand castles, boat, or house?";
        ...
        Toast.makeText(Q20.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("hot")) {
                        ...
                        Toast.makeText(Q20.this, correctAns+"", Toast.LENGTH_SHORT).show();
