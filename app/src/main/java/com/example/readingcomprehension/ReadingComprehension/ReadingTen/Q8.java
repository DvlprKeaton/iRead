...
public class Q8 extends AppCompatActivity {
    ...
    public void Q1N2(){
        ...
        Toast.makeText(Q8.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("dirty")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q9.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q8.this, correctAns+"", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intentQ2 = new Intent(this, Q9.class);
