...
public class Q12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("How old is billy's little brother?" +
                "\n• 10" +
                "\n• 5" +
                "\n• 3");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "How old is billy's little brother?" +
                "is it 10, 5, or 3?";
        ...
        Toast.makeText(Q12.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("5")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q13.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q12.this, correctAns+"", Toast.LENGTH_SHORT).show();
