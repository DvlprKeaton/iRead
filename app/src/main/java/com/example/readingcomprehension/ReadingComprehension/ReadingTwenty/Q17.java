...
public class Q17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("I live in an apartment with my _____" +
                "\n• parents" +
                "\n• friends" +
                "\n• cousins");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "I live in an apartment with my blank..." +
                "is it parents, friends, or cousins";
        ...
        Toast.makeText(Q17.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("parents")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q18.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q17.this, correctAns+"", Toast.LENGTH_SHORT).show();
