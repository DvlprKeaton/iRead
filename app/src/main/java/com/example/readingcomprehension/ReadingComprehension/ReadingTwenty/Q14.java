...
public class Q14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("Who helps him in his studies?" +
                "\n• Billy" +
                "\n• Mother" +
                "\n• Father");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "Who helps him in his studies?" +
                "is it Billy, mother or Father?";
        ...
        Toast.makeText(Q14.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("Billy")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q15.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q14.this, correctAns+"", Toast.LENGTH_SHORT).show();
