...
public class Q7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("It went to the farm.\n" +
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "It went to the farm." +
                "I saw a dog and a pig." +
                "The pig was dirty." +
                "The dog was wet." +
                "Continue the given sentence." +
                "I saw blank..." +
                "is it a bird and a pig, a dog and a cat, or a dog and a pig";
        ...
        Toast.makeText(Q7.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("a dog and a pig")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q8.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q7.this, correctAns+"", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intentQ2 = new Intent(this, Q8.class);
