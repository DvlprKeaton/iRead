...
public class Q13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("Which sport does he love to play?" +
                "\n• cricket" +
                "\n• hockey" +
                "\n• football");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "Which sport does he love to play?" +
                "is it cricket, hockey, or football?";
        ...
        Toast.makeText(Q13.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("football")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q14.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q13.this, correctAns+"", Toast.LENGTH_SHORT).show();
