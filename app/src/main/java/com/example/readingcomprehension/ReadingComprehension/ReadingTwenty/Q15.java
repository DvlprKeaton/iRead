...
public class Q15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("Hello friends, My name is Noah." +
                "\nI am 10 years old. I am from New York. I live in an apartment with my parents." +
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "Hello friends, My name is Noah." +
                "I am 10 years old. I am from New York. I live in an apartment with my parents." +
                "I like playing football." +
                "Continue the following sentences..." +
                "My name is blank..." +
                "is it lisa, noah, or john?";
        ...
        Toast.makeText(Q15.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("noah")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q16.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q15.this, correctAns+"", Toast.LENGTH_SHORT).show();
