...
public class Q18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("I like playing _____" +
                "\n• chess" +
                "\n• basketball" +
                "\n• football");
    }
    public void Q1N2(){
        ...
        String Q1N1 = "I like playing blank..." +
                "is it chess, basketball, or football?";
        ...
        Toast.makeText(Q18.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
            ...
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("football")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q19.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q18.this, correctAns+"", Toast.LENGTH_SHORT).show();
