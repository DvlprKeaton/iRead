...
public class Q4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("What two adjectives describe the spots?\n" +
                "\n• itchy and red" +
                "\n• black and blue" +
                "\n• red and white");
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "" +
                "is it itchy and red, black and blue or red and white";
        ...
        Toast.makeText(Q4.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("itchy and red")) {
                        ...
                        Intent intentQ3 = new Intent(this, Q5.class);
                        startActivity(intentQ3);

                        Toast.makeText(Q4.this, correctAns+"", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intentQ2 = new Intent(this, Q5.class);
