...
import com.example.readingcomprehension.ReadingComprehension.ReadingComprehensionProgress;
import com.example.readingcomprehension.ReadingComprehension.ReadingTwenty.Q11;
...
public class Q10 extends AppCompatActivity {
    ...
    public void Q1N2(){
        ...
        String Q1N1 = "Continue the given sentence." +
                "I went to blank..." +
                "is it the farm, the beach, or the school";
        ...
        Toast.makeText(Q10.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("the farm")) {
                        ...
                        if (numberQ == 10){
                            Intent intentQ3 = new Intent(this, ReadingComprehensionProgress.class);
                            startActivity(intentQ3);
                        }else {
                            Intent intentQ3 = new Intent(this, Q11.class);
                            startActivity(intentQ3);
                        }


                        Toast.makeText(Q10.this, correctAns+"", Toast.LENGTH_SHORT).show();
