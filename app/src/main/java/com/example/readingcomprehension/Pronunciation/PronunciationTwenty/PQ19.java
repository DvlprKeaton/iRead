...
public class PQ19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq19);
    ...
    public void Q1N1(){
        ...
        Toast.makeText(PQ19.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("true")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ20.class);
