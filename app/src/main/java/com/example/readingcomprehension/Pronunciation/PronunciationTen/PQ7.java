...
public class PQ7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq7);
        ...
        q1.setText("What is the sound that you make when you think something is funny?" +
                "\n• laugh" +
                "\n• cry" +
                "\n• mope" +
                "\n• aloft");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "What is the sound that you make when you think something is funny?" +
                " is it laugh, cry, mope, or aloft?";
        ...
        Toast.makeText(PQ7.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("laugh")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ8.class);
