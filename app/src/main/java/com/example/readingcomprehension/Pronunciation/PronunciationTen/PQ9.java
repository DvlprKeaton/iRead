...
public class PQ9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq9);
        ...
        q1.setText("Which word means the OPPOSITE of the word lost in the sentence given?" +
                "\nPaige lost her favorite stuffed animal." +
                "\n• dropped" +
                "\n• found" +
                "\n• hugged" +
                "\n• heard");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Which word means the OPPOSITE of the word lost in the sentence given?" +
                "Paige lost her favorite stuffed animal." +
                " is it dropped, found, hugged, or heard?";
        ...
        Toast.makeText(PQ9.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("found")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ10.class);
