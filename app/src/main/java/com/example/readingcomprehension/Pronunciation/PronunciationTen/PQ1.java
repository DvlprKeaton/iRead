...
public class PQ1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("Choose the correct verb to fill in the blank." +
                "\nThe boys ______ in the car" +
                "\n• am" +
                "\n• was" +
                "\n• were" );
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Choose the correct verb to fill in the blank." +
                "The boys BLANK in the car...." +
                " is it am, was, or were?";
        ...
        Toast.makeText(PQ1.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("were")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ2.class);
