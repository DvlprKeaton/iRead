...
public class PQ8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq8);
        ...
        q1.setText("Choose the verb in the sentence." +
                "\n• prince" +
                "\n• tower" +
                "\n• climbed");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Choose the verb in the sentence." +
                "The prince climbed the tower." +
                " is it prince, tower, or climbed?";
        ...
        Toast.makeText(PQ8.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("climbed")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ9.class);
