...
public class PQ13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq13);
        ...
        q1.setText("When something is not fair" +
                "\n• fairest" +
                "\n• faire" +
                "\n• refaire" +
                "\n• unfair");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "When something is not fair, it is" +
                " fairest, faire, refaire, or unfair?";
        ...
        Toast.makeText(PQ13.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("unfair")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ14.class);
