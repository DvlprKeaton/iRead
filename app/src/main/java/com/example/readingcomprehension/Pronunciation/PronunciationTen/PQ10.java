...
import com.example.readingcomprehension.Pronunciation.PronunciationProgress;
import com.example.readingcomprehension.Pronunciation.PronunciationTwenty.PQ11;
import com.example.readingcomprehension.R;

import java.util.ArrayList;
import java.util.Locale;

public class PQ10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq10);
        ...
        q1.setText("What is the opposite of the word “short”?" +
                "\n• long" +
                "\n• big" +
                "\n• pretty" +
                "\n• love");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "What is the opposite of the word “short”?" +
                "is it long, big, pretty, or love?";
        ...
        Toast.makeText(PQ10.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("long")) {
                        ...
                        if (numberQ == 10){
                            Intent intentQ3 = new Intent(this, PronunciationProgress.class);
                            startActivity(intentQ3);
                        }else {
                            Intent intentQ3 = new Intent(this, PQ11.class);
                            startActivity(intentQ3);
                        }
