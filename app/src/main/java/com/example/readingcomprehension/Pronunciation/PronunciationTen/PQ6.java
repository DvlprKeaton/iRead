...
public class PQ6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq6);
        ...
        q1.setText("What is the word that means “saving someone from danger”?" +
                "\n• instinct" +
                "\n• rescue" +
                "\n• fast-paced" +
                "\n• family");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "What is the word that means “saving someone from danger”?" +
                " is it instinct, rescue, fast-paced, or family?";
        ...
        Toast.makeText(PQ6.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("rescue")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ7.class);
