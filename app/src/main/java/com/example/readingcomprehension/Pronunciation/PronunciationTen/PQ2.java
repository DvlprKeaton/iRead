...
public class PQ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1.setText("I _____ with my fingers" +
                "\n• touch" +
                "\n• taste" +
                "\n• hear");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "I BLANK with my fingers.." +
                " is it touch, taste, or hear?";
        ...
        Toast.makeText(PQ2.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("touch")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ3.class);
