...
public class PQ14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq14);
        ...
        q1.setText("Which word represents playing something again?" +
                "\n• unplay" +
                "\n• player" +
                "\n• replay" +
                "\n• played");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Which word represents playing something again?" +
                " is it unplay, player, replay, or played?";
        ...
        Toast.makeText(PQ14.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("replay")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ15.class);
