...
public class PQ16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq16);
        ...
        q1.setText("When you are upset about something, you are..." +
                "\n• happy" +
                "\n• unhappy" +
                "\n• happiest" +
                "\n• unangry");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "When you are upset about something, you are..." +
                " happy, unhappy, happiest, or unangry?";
        ...
        Toast.makeText(PQ16.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("unhappy")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ17.class);
