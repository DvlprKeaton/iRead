...
public class PQ3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq3);
    ...
    public void Q1N1(){
        ...
        Toast.makeText(PQ3.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
            ...
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("True")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ4.class);
