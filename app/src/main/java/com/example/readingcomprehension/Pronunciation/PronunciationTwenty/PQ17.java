...
public class PQ17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq17);
        ...
        q1.setText("When you want to watch something again you _____ it." +
                "\n• unwatch" +
                "\n• watchless" +
                "\n• rewatch" +
                "\n• watched");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "When you want to watch something again you BLANK it." +
                " is it unwatch, watchless, rewatch, or watched?";
        ...
        Toast.makeText(PQ17.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("rewatch")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ18.class);
