...
public class PronunciationProgress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pronunciation_progress);
        ...
        retake.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PronunciationProgress.this, PQ1.class);
        ...
        backm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PronunciationProgress.this, MainActivity.class);
                startActivity(intent);
