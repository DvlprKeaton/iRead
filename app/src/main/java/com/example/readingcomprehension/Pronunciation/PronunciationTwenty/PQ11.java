...
public class PQ11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq11);
        ...
        q1.setText("What is the past tense for drink?" +
                "\n• drinks" +
                "\n• drinked" +
                "\n• drinking" +
                "\n• drank");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "What is the past tense for drink?" +
                " is it drinks, drinked, drinking, or drank?";
        ...
        Toast.makeText(PQ11.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("drank")) {
                        ...
                        editor.commit();
                            ...
                            Intent intentQ3 = new Intent(this, PQ12.class);
