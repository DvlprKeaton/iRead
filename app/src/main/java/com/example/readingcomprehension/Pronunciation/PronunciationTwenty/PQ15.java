...
public class PQ15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq15);
        ...
        q1.setText("Someone who is joyful is" +
                "\n• without joy" +
                "\n• full of joy" +
                "\n• joyless" +
                "\n• little happy");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Someone who is joyful is" +
                "without joy, full of joy, joyless, or a little happy?";
        ...
        Toast.makeText(PQ15.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("full of joy")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ16.class);
