...
public class PQ12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq12);
        ...
        q1.setText("Kai'leah and Tatyana _____ all day." +
                "\n• not here" +
                "\n• slept" +
                "\n• sleeps" +
                "\n• sleeped");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Kai'leah and Tatyana BLANK all day." +
                " is it sleeped, sleeps, slept, or not here";
        ...
        Toast.makeText(PQ12.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("slept")) {
                        ...
                        Intent intentQ3 = new Intent(this, PQ13.class);
