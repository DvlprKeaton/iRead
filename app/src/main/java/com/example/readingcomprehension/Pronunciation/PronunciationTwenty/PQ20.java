...
public class PQ20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq20);
        ...
        q1.setText("Which word in this sentence is the VERB?\n" +
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Which word in this sentence is the VERB?" +
                "Mom sang along to the pretty music." +
                " is it music, sang, mom or pretty?";
        ...
        Toast.makeText(PQ20.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("sang")) {
