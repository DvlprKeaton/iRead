...
public class PQ4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pq4);
        ...
        q1.setText("Which of these words is a NOUN?" +
                "\n• cat" +
                "\n• hit" +
                "\n• red" +
                "\n• sing");
    ...
    public void Q1N1(){
        ...
        String Q1N1 = "Which of these words is a NOUN?" +
                " is it cat, hit, red, or sing?";
        ...
        Toast.makeText(PQ4.this, Q1N1, Toast.LENGTH_SHORT).show();
    }
        ...
        switch (requestCode) {
            case RESULT_SPEECH:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (results.getText().toString().equals("cat")) {
                        ...
                        Intent intentQ2 = new Intent(this, PQ5.class);
